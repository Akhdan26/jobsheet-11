...
@section('konten')
    ...
    <form action="/mahasiswa/update/{{ $mahasiswa->id }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" required="required" name="nimmhs" value="{{ $mahasiswa->nim }}"> <br>
        </div>
        <div class="form-group">
            <label for="emailmhs">E-mail</label>
            <input type="text" class="form-control" required="required" name="emailmhs" value="{{ $mahasiswa->email }}"> <br>
        </div>
        <div class="form-group">
